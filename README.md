...
```bash
git https://github.com/adnan-bhaldar/Apple-Iphone-Clone.git
...
Public Assets used in the project can be found [here](https://github.com/adnan-bhaldar/Apple-Iphone-Clone)
